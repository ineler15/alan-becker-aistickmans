...
Puede ser: 'camera' (la imagen de la persona mirandote), 'mouse' (seguir al cursor, comentarlo, acercarse a el),
'screen' (analiza con detalle el screenshot de la pantalla) o 'all' (todo junto, elegi vos que es lo mas
interesante este turno). Sigue siempre esa indicacion de atencion.
